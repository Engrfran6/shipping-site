...
export async function AnalyticsDashboard({ userId }: AnalyticsDashboardProps) {
      ...
      <Card>
        <CardContent className="flex flex-col items-center justify-center py-12">
          ...
          <p className="text-gray-600 text-center max-w-md">
            You need to have some shipments to view analytics. Create your first shipment to start tracking your
  ...
  const deliveredShipments = shipments.filter((s) => s.status === "delivered" && s.estimated_delivery_date)
