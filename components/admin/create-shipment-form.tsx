    ...
    try {
      ...
      const { data: shipmentData, error: shipmentError } = await supabase
        ...
        .insert({
          ...
          // ).toISOString(),
          estimated_delivery_date: new Date(
            Date.now() + Number(costData?.estimated_delivery_days) ||
              0 * 24 * 60 * 60 * 1000
          ).toISOString(),
        })
        .select()
                ...
                <div className="grid md:grid-cols-2 gap-4">
                  ...
                  <div>
                    ...
                    <Input
                      ...
                      onChange={(e) =>
                        updateFormData("senderEmail", e.target.value)
                      }
                    />
                  </div>
                </div>
                ...
                <div className="grid md:grid-cols-3 gap-4">
                  <div>
                    ...
                    <Input
                      ...
                      onChange={(e) =>
                        updateFormData("senderCity", e.target.value)
                      }
                    />
                  </div>
                  <div>
                    ...
                    <Input
                      ...
                      onChange={(e) =>
                        updateFormData("senderState", e.target.value)
                      }
                    />
                  </div>
                  <div>
                    ...
                    <Input
                      ...
                      onChange={(e) =>
                        updateFormData("senderPostalCode", e.target.value)
                      }
                    />
                  </div>
                </div>
              ...
              <div className="space-y-4">
                ...
                <div>
                  ...
                  <Input
                    ...
                    onChange={(e) =>
                      updateFormData("recipientAddress", e.target.value)
                    }
                  />
                </div>
                <div className="grid md:grid-cols-3 gap-4">
                  <div>
                    ...
                    <Input
                      ...
                      onChange={(e) =>
                        updateFormData("recipientCity", e.target.value)
                      }
                    />
                  </div>
                  <div>
                    ...
                    <Input
                      ...
                      onChange={(e) =>
                        updateFormData("recipientState", e.target.value)
                      }
                    />
                  </div>
                  <div>
                    ...
                    <Input
                      ...
                      onChange={(e) =>
                        updateFormData("recipientPostalCode", e.target.value)
                      }
                    />
                  </div>
                </div>
        ...
        {step === 2 && (
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Describe your package for accurate pricing
              </CardDescription>
            </CardHeader>
            <CardContent className="space-y-6">
              <div className="grid md:grid-cols-2 gap-4">
              ...
              <div className="flex justify-between">
                ...
                <Button
                  ...
                  className="bg-blue-600 hover:bg-blue-700 text-white"
                  disabled={
                    formData.packageType === "" && formData.weightKg === ""
                  }
                >
                  Next Step <ArrowRight className="ml-2 h-4 w-4" />
                </Button>
        ...
        {step === 3 && (
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Choose your shipping service and additional options
              </CardDescription>
            </CardHeader>
            <CardContent className="space-y-6">
              <div>
                ...
                >
                  ...
                  <SelectContent>
                    ...
                    <SelectItem value="express">
                      Express (2-3 days) - Faster delivery
                    </SelectItem>
